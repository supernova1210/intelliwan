...
export function ContactCenterCta() {
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-[#004467]/10 flex items-center justify-center">
              <Headphones className="w-8 h-8 text-[#004467]" />
            </div>
          </motion.div>
          ...
          >
            Envie de repenser votre centre de contact ?
          </motion.h2>
          ...
          >
            Discutons de votre situation, vos objectifs et construisons ensemble une solution adaptée.
          </motion.p>

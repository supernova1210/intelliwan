        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <div className="w-16 h-16 rounded-2xl bg-[#004467]/10 flex items-center justify-center">
              <ShieldAlert className="w-8 h-8 text-[#004467]" />
            </div>
          </motion.div>
          ...
          >
            {"Besoin d'un dispositif de crise adapté à votre environnement ?"}
          </motion.h2>
          ...
          >
            {"Échangeons sur vos enjeux de continuité d'activité et d'alerte. Nous concevons des solutions sur mesure pour chaque site sensible."}
          </motion.p>
